        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div class="grid gap-8 md:grid-cols-2 my-8">
                <article class="bg-white dark:bg-gray-900">
                    <div>
                        <img src="https://dummyimage.com/400" alt="image" class="h-96 w-full mb-4">
                    </div>
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="article.php">How to
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 py-8">
                <article class="bg-white dark:bg-gray-900">
                    <div>
                        <img src="https://dummyimage.com/200" alt="image" class="h-48 w-full mb-4">
                    </div>
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <span
                            class="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
